...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 29 Jun 2023 pada 05.37
...
INSERT INTO `menu_items` (`item_id`, `item_name`, `category_id`, `price`) VALUES
(1, 'Kopi Latte', 1, 15000.00),
(2, 'Nasi Goreng', 2, 25000.00),
(3, 'French Fries', 3, 12000.00);
...
(1, '', '$password', '$email', '2023-06-28 20:57:21');
